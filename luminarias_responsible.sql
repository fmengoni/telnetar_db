...
CREATE TABLE `responsible` (
  ...
  KEY `FK_responsiblerole_responsible_id` (`responsible_id`),
  CONSTRAINT `FK_responsiblerole_responsible_id` FOREIGN KEY (`responsible_id`) REFERENCES `role` (`role_id`)
...
-- Dump completed on 2018-05-16 18:37:04
